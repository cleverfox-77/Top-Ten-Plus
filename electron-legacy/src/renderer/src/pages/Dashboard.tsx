...
import type { DashboardSummary } from '../../../main/services/analytics'
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        ...
        <div className="card p-5">
          <div className="mb-4 flex items-center gap-2">
            <AlertTriangle
              size={18}
              className={low.length ? 'text-amber-500' : 'text-gray-300'}
            />
          ...
          {low.length === 0 ? (
            ...
            <div className="space-y-2">
              ...
              {isAdmin && (
                <Link to="/stock" className="mt-2 inline-block text-sm text-brand-600 hover:underline">
                  Manage stock →
                </Link>
              )}
            </div>
