...
import { t, PAYMENT_LABELS } from '@shared/labels'
import { GARMENTS, GARMENT_ORDER, StyleControl } from '@shared/garments'
import { ALL_UNITS, UNIT_LABELS, fromBase, round2 } from '@shared/units'
import type {
  Customer,
  Fabric,
  FabricUnit,
