...
import { GARMENT_ORDER } from '@shared/garments'
import { STATUS_FLOW } from '../lib/status'
import { bdt, fmtDate } from '../lib/format'
import type { Order, OrderStatus, GarmentType, User } from '@shared/types'
...
export default function SalesHistory(): JSX.Element {
  ...
  const exportCsv = async (): Promise<void> => {
    ...
    try {
      const ok = await api.app.exportSalesCsv(data)
      if (ok) toast.success('Exported to CSV')
    } catch (e) {
